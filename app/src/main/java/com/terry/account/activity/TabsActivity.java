...
import com.terry.account.fragment.UserFragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.drawer_item_about:
                ...
                break;
            case R.id.drawer_item_userseting:
                getSupportActionBar().setTitle(R.string.drawer_item_userseting);
                changeFragment(UserFragment.getInstance());
                break;
            case R.id.loginout:
                showExitDialog();
                break;
